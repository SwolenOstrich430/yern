...
-- Database: PostgreSQL
-- Generated at: 2025-09-27T20:08:58.946Z
...
CREATE TABLE "yern"."service_providers" (
  "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "name" text NOT NULL,
  "type" enum NOT NULL
);
...
ALTER TABLE "yern"."files" ADD FOREIGN KEY ("storage_provider_id") REFERENCES "yern"."service_providers" ("id");
