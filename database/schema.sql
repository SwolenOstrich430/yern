...
-- Database: PostgreSQL
-- Generated at: 2025-10-09T15:27:30.199Z
...
CREATE TABLE "yern"."section_counters" (
...
CREATE TABLE "yern"."section_counter_logs" (
...
ALTER TABLE "yern"."section_counters" ADD FOREIGN KEY ("section_id") REFERENCES "yern"."sections" ("id");

ALTER TABLE "yern"."section_counter_logs" ADD FOREIGN KEY ("section_id") REFERENCES "yern"."sections" ("id");
